...
def get_pricing(country_code):
    ...
    if country_code == 'IN':
        return {
            ...
            'starter': {'replies': 100, 'price': 99, 'label': 'Starter'},
            'popular': {'replies': 500, 'price': 299, 'label': 'Popular'},
            'pro': {'replies': 1500, 'price': 599, 'label': 'Pro'}
        }
    else:
        return {
            'free': {'replies': 10, 'label': 'Free'},
            'starter': {'replies': 100, 'price': 9, 'label': 'Starter'},
            'popular': {'replies': 500, 'price': 19, 'label': 'Popular'},
            'pro': {'replies': 1500, 'price': 39, 'label': 'Pro'}
        }
