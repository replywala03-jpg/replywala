...
if page == 'home':
    ...
    if st.session_state.comments:
        ...
        <div class="stats-row">
            ...
            <div class="stat-item"><div class="number">100%</div><div class="label">AI Generated</div></div>
        </div>
        """.format(total, posted, total - posted), unsafe_allow_html=True)
...
# ==================== FEATURES PAGE ====================
    ...
    <div style="text-align: center; padding: 20px 0;">
        <p style="color: #636e72;">Ready to try it? <a href="#" onclick="window.location.reload();" style="color: #e94560; font-weight: 600;">Go to Home →</a></p>
    </div>
    """, unsafe_allow_html=True)
...
# ==================== PRICING PAGE ====================
    ...
    <div class="pricing-grid">
        <div class="pricing-card">
            ...
            <div class="plan-price">₹99 <span>/ 100 replies</span></div>
            <ul class="plan-features">
                <li>100 AI-generated replies</li>
        ...
        <div class="pricing-card popular">
            ...
            <div class="plan-price">₹299 <span>/ 500 replies</span></div>
            <ul class="plan-features">
                <li>500 AI-generated replies</li>
                <li>Review before posting</li>
        ...
        <div class="pricing-card">
            ...
            <div class="plan-price">₹599 <span>/ 1500 replies</span></div>
            <ul class="plan-features">
                <li>1500 AI-generated replies</li>
                <li>Review before posting</li>
                <li>Advanced analytics</li>
                <li>Priority support</li>
                <li>Smart filtering</li>
    ...
    <div style="text-align: center; padding: 8px 0;">
        <p style="color: #636e72; font-size: 14px;">💳 All plans include UPI, Credit Card, and Bank Transfer options</p>
        <p style="color: #636e72; font-size: 14px;">🌍 Prices shown in INR for India. USD pricing available for international creators.</p>
    </div>
    """, unsafe_allow_html=True)
...
# ==================== DASHBOARD PAGE ====================
    ...
    if not os.path.exists('token.pickle'):
        ...
        credits_used = total_replies * 1  # Each reply uses 1 credit
        ...
        <div class="stats-row">
            ...
            <div class="stat-item"><div class="number">{}</div><div class="label">Credits Used</div></div>
            <div class="stat-item"><div class="number">100%</div><div class="label">AI Accuracy</div></div>
        </div>
        """.format(total_comments, total_replies, credits_used), unsafe_allow_html=True)
